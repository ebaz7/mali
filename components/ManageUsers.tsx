...
import { UserPlus, Trash2, Shield, User as UserIcon, Download, CloudOff, Pencil, X, Save, Container, Camera, Send, Phone } from 'lucide-react';
...
const ManageUsers: React.FC = () => {
  ...
  const [formData, setFormData] = useState({ username: '', password: '', fullName: '', role: UserRole.USER, canManageTrade: false, avatar: '', telegramChatId: '', phoneNumber: '' });
